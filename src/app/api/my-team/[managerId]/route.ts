...
export async function GET(
  ...
  try {
    // Fix the warning by using the params object directly
    ...
    // Fetch user's team
    const teamResponse = await fetch(`https://fantasy.premierleague.com/api/entry/${managerId}/event/${currentEvent}/picks/`);

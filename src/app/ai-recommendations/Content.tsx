  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 bg-gradient-to-r from-[var(--fpl-purple-light)] to-[var(--fpl-blue-light)] p-5 rounded-lg shadow-md border border-[var(--fpl-purple-light)]">
          <div className="flex flex-col md:flex-row items-start md:items-center">
            <div className="flex-shrink-0 mb-3 md:mb-0 md:mr-4">
              <div className="bg-[var(--fpl-purple-dark)] text-white p-2 rounded-full">
            ...
            <div>
              <h3 className="text-lg font-bold text-[var(--fpl-purple-dark)]">
                AI Recommendations & Captain Picks for Gameweek 29
              </h3>
              <p className="text-[var(--fpl-purple-dark)] mt-1">
                This page provides data-driven FPL recommendations powered by our advanced AI algorithms. Get personalized transfer suggestions based on your team, optimal captain picks with confidence scores, and differential players to help you climb the rankings.
              </p>
              <p className="text-[var(--fpl-purple-dark)] mt-2">
                We've improved our captain recommendations with accurate player data and detailed reasoning. Our top picks for GW29 include Haaland, Foden, and Salah, with predicted points and confidence scores to help you make the best decision.
              </p>
              <p className="text-[var(--fpl-purple-dark)] mt-2 text-sm">
                <span className="font-semibold">New feature:</span> We've added validation to ensure all player recommendations match their descriptions, giving you more reliable insights.
              </p>
            </div>
          </div>
        </div>
